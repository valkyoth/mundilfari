...
grep -q 'Hard-bound assumption content is immutable' docs/modularity-policy.md
...
grep -q 'provider-neutral verifier alone creates opaque `VerifiedArtifactEvidence`' docs/modularity-policy.md
