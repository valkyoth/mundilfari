...
REVIEW_COVERAGE = {
    ...
    "v0.52.3": (
        ...
        "cannot update `TrustedClock`",
        "`mundilfari-engine` owns admission policy",
        "cannot construct admitted values",
    ),
    ...
    "v0.75.1": (
        ...
        "earliest conservative certificate-chain",
        "worst-case upper trusted-time bound",
        "concrete verified reference",
        "resumption tickets carry only",
        "never a TLS connection",
    ),
    "v0.75.2": (
    ...
    "v0.77.0": ("ServiceCredentialContextId", "NtsAssociationGeneration"),
    "v0.78.1": ("draft-ietf-ntp-nts-keyexchange-pool-01",),
    "v0.79.1": ("amplification",),
    "v0.80.0": ("partial overlap remains `Indeterminate`",),
    "v0.81.0": (
        "distinct ticket, TLS connection, exporter, NTS association",
    ),
    "v0.91.0": ("PTPv3",),
    ...
    "v0.148.0": (
        ...
        "ServiceCredentialContextId",
        "fresh TLS connection/exporter/NTS association generation hierarchy",
        "HardBoundClaim",
        "AdmittedLeapCandidate",
        "AdmittedEopSnapshot",
        "AdmittedScaleOffsetSnapshot",
    ...
    "v0.162.0": (
        ...
        "TemporalValidationEvidence",
        "scalar `UnixTime`",
        "conservative revalidation-horizon calculation",
        "whole-chain temporal",
    ),
    "v0.163.0": ("every interval endpoint combination",),
    "v0.164.0": ("Android/iOS lifecycle evidence",),
    "v0.166.0": ("safe-facade panic contract", "open/closed/half-open sets"),
