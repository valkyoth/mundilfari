...
REVIEW_COVERAGE = {
    ...
    "v0.7.2": (
        "Hard-Bound Assumption Identity And Composition",
        "BoundAssumptionSet",
        "content-addressed `BoundAssumptionsId`",
        "caller-selected/substituted identifiers",
        "intersection and consensus conjunct",
        "preserve every input assumption",
        "IncompatibleAssumptions",
        "AssumptionCapacityExceeded",
        "reconstruct or weaken",
    ),
    "v0.12.0": (
        "TAI-to-UTC",
    ...
    "v0.8.0": ("v0.7.1", "HardBoundClaim<AtomicInstant>"),
    "v0.9.0": (
        "maximum limb width",
    ...
    "v0.52.3": (
        ...
        "configured-platform-trust versus cryptographic",
        "custom adapter",
        ...
        "cannot update `TrustedClock`",
        "`mundilfari-engine` owns provider-neutral verification",
    ...
    "v0.60.0": (
        ...
        "incompatible/exhausted combinations",
    ),
    "v0.61.0": (
        "engine-owned",
        "without either reimplementing",
        "preserving the exact hard-bound assumption",
    ),
    "v0.61.1": (
    ...
    "v0.133.0": (
        ...
        "second intersection",
        "exact contributing `v0.7.2` assumption identities",
        "never reconstructs assumptions",
    ),
    ...
    "v0.166.0": (
        ...
        "immutable assumption composition",
