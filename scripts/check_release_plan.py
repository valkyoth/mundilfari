...
REVIEW_COVERAGE = {
    ...
    "v0.12.1": ("one authenticated malicious server", "atomic activation"),
    ...
    "v0.17.0": ("leap-announcement authority", "monotonic-domain"),
    ...
    "v0.146.0": ("TamperEvident", "explicit gap/loss events"),
    "v0.147.0": ("opaque secret-provider/key references", "atomic activate"),
    "v0.148.0": ("honest ahead recovery", "configuration/audit semantics"),
