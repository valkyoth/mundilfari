...
def extend_runtime_review_rules(
    ...
    additions = {
        ...
        "v0.7.4": (
            "Borrowed And Owned Hard-Claim Ownership",
            "no third public `HardBoundClaim` type",
            "BorrowedHardBoundClaim<'arena, T>",
            "OwnedHardBoundClaim<T>",
            "`try_promote_set(roots, capacity)`",
            "OwnedHardBoundClaimSet<T>",
            "deduplicated total-owner",
            "`try_compact_roots",
            "unbounded retention",
            "batch canonical identity equivalence",
            "Arc-style owner",
            "required pointer-atomic capability",
            "borrowed-to-owned `try_promote()`",
            "imports/reinterns",
            "collision checks",
            "HardBoundClaimView<'view, T>",
            "borrow or handle into the unverified source arena",
            "source arena after successful engine promotion",
            "no_std engines explicitly borrow",
            "EngineProofHandle<'engine, K, T>",
            "allocate no parallel store",
            "self-contained owned-state",
            "`'static` closure/thread",
            "compile-fail borrowed-claim escape",
        ),
        ...
        "v0.17.0": (
            ...
            "`v0.7.4` ownership/promotion audit",
            "owned frozen arenas avoid self-reference",
            "borrowed/owned promotion",
            "multi-root promotion audit",
            "individual/batch",
            "compile-fail lifetime-escape",
        ...
        "v0.60.1": (
            "Runtime Bound-Condition Assessment",
            "ConditionAssessment",
            "Supported",
            "Contradicted",
            "Indeterminate",
        ...
        "v0.60.6": (
            ...
            "`PolicyAcceptedHardBound<T>` is likewise source-arena-independent",
            "PolicyAcceptedHardBoundRef<'engine, T>",
            "source arena/owner to drop",
            ...
            "partial assessment/token can issue",
        ...
        "v0.137.7": ("condition-assessment loss",),
        "v0.138.0": (
            "self-contained `TrustedClock`",
            "self-referential/leaked owner",
            "caller-storage lifetime",
            "return-from-builder",
        ...
        "v0.140.0": (
            ...
            "lease policy",
            "exhaustion behavior",
            "borrowed builder families",
            "maximum roots",
            "deduplicated storage",
            "one-root specialization",
            "frozen-arena capacity/share",
            "return self-contained owners",
        ...
        "v0.144.0": (
            "context owns bounded promoted/frozen",
            "Rust arena borrows exist only during individual",
            "context close invalidates children",
            "destruction in every order",
            "concurrent close/use",
            "no partially returned handle",
        ),
        "v0.145.0": (
        ...
        "v0.148.0": (
            ...
            "`OwnedHardBoundClaim` forms",
            "canonical fallible promotion",
            "multi-root shared-DAG promotion",
            "source-arena-independent engine",
            "no_std inline/checked-engine-store",
            "provider-owned",
        ...
        "v0.160.0": (
            ...
            "atomic rollback",
            "unique/shared frozen-owner accounting",
        ...
        "v0.161.0": (
            ...
            "concurrent close/use",
            "per-call Rust arena borrows",
            "outlives a borrowed branded claim",
        ),
        "v0.163.0": (
            "runtime condition",
            ...
            "borrowed-claim lifetime escape",
            "owned-promotion",
        ...
        "v0.164.0": (
            "Arc-style frozen sharing",
            "pointer atomics",
            "unique ownership or an explicit non-claim",
            "monotonic provider",
            "strict-authority",
            "through-completion",
        ...
        "v0.166.0": (
            ...
            "borrowed versus owned claim lifetimes",
            ...
            "source-drop versus evidence-generation",
            "`'static` async",
            "context/child ownership",
            "provider-owned monotonic",
            "linearization-time `observed_at`/`valid_until`",
            "WCET-backed",
            "early non-authoritative",
            "restore type-state",
            "verified root/",
