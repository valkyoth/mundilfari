...
def extend_runtime_review_rules(
    ...
    additions = {
        ...
        "v0.60.1": (
            ...
            "engine-owned, lifetime-independent",
            "no borrow, brand, handle",
            "`UnverifiedBoundDerivation<T>`",
            "`DerivationHandle<'arena, T>`",
            ...
            "`PolicyAcceptedHardBound<T>` is likewise engine-owned",
        ...
        "v0.148.0": (
            ...
            "lifetime-independent engine proof/",
            "provider-owned",
        ...
        "v0.166.0": (
            ...
            "lifetime-independent verified root/",
