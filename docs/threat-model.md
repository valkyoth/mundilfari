...
| Facade erases conditional trust basis | strict path requires a current accepted bound; diagnostic path exposes condition, assessment, reasons, assurance, deadline, and non-claims; no `is_trusted` boolean |
